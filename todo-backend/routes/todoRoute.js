...
const { createNewTODO, addNewTodo, updateTodo, getAllTodos, deleteTodo, getTask, createTodo } = require("../controller/todoListController");
...
todoRouter.route("/create-todo").post(authorization, createTodo);
